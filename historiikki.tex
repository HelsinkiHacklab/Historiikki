...
% marginaalit, ehkä parempi tapa tehdä aikajana
...
Yhteistyö laajeni yhä erilaisempiin suuntiin: muutamat Hacklabin jäsenet ottivat osaa mm. Vantaan taidemuseossa esillä olleeseen Harri Larjoston robottiteokseen, jonka tekniikka perustui muokattuihin Roomba-siivousrobotteihin. Pienoismallikerhon \textit{Stadi-mallarit} kanssa sovittiin yhteistyöstä tilojen käytöstä jäsenten kesken, sillä tuolloin työpajamme sijaitsivat vielä melko lähellä toisiaan.

\uusivuosi{2013}
\section*{Kasvu jatkuu}
