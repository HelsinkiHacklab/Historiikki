...
Ensi kertaa yhdistyksen alkuvaiheiden ongelmien jälkeen yhdistys joutui miettimään uudestaan, mitä hacklab-toiminnan haluttiin olevan. Käytäntöjä henkilökohtaisten tavaroiden säilyttämisestä sovitettiin kasvaneeseen jäsenmäärään, toiminnan avoimuuteen kiinnitettiin huomiota ja vanhoille jäsenille muotoutuneita etuoikeuksia purettiin.

\jana{1.6.2014 Henkilökohtaisten tavaroiden säilytyksessä siirryttiin vakiolaatikkoihin}
